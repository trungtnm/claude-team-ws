...
export function CaptureComposer() {
  const { composerOpen, closeComposer, addCapture } = useCaptureStore()
  ...
  const handleSubmit = useCallback(() => {
    ...
    addCapture(trimmed, {
      ...
      ...(captureType !== null && { type: captureType }),
    })
  ...
  }, [text, priority, captureType, attachments, addCapture, closeComposer, resetForm])
  ...
  }, [text, priority, captureType, addCapture, resetForm])
