...
export const knowledgeRules = sqliteTable('knowledge_rules', {
  ...
  category: text('category', {
    enum: ['coding', 'security', 'testing', 'architecture', 'general'],
...
export const activityLog = sqliteTable('activity_log', {
  ...
  action: text('action', {
    enum: [
      'capture_created', 'epic_created', 'session_started', 'session_completed',
      'pr_created', 'pr_merged', 'rule_created', 'bead_status_changed',
    ],
  }).notNull(),
